...
data_root = '/data/DLY/YunNan/mmdetection/datasets/v3-coco-mmdet-batch2/'
...
interval = 10
launcher = 'none'
load_from = '/data/DLY/YunNan/vehicle-detection/work_dirs/yolox_s_8xb8-300e_coco_v3/best_coco_bbox_mAP_epoch_180.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ann_file=
    '/data/DLY/YunNan/mmdetection/datasets/v3-coco-mmdet-batch2/annotations/instances_val.json',
    backend_args=None,
    classwise=True,
    metric='bbox',
    type='CocoMetric')
...
train_dataloader = dict(
    ...
    dataset=dict(
        dataset=dict(
            ...
            data_root=
            '/data/DLY/YunNan/mmdetection/datasets/v3-coco-mmdet-batch2/',
